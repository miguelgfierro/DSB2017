...
echo "MIGLOG: Executing prepare.py ..."
#set -e
#python prepare.py

echo ""
echo "MIGLOG: Executing detector ..."
cd detector
eps=100
CUDA_VISIBLE_DEVICES=0,1,2,3,4 python main.py --model res18 -b 16 --epochs $eps --save-dir res18 --workers 24 
echo ""
echo "MIGLOG: Executing detector --resume  --test 1"
...
echo ""
echo "MIGLOG: Executing classifier ..."
cd ../classifier
...
echo ""
echo "MIGLOG: Training process finished"
